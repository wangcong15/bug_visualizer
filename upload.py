...
r = requests.post("http://" + server_ip + ":" + server_port + "/bug_history/", files={'file':open(project_path, 'rb')})
result = (str(r) == "<Response [200]>")

r = requests.post("http://" + server_ip + ":" + server_port + "/bug_history/", files={'file':open(xml_path, 'rb')})
